...
|---|---|---|---|
| `value` | `string` | `""` | Text value to display; supports `$param_name`/`{{udf_name}}` placeholders in the app (rendered as-is in fused). Lower priority than `sql`. |
